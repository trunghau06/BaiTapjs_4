class ResponsiveVirtualView {
    ...
    setupHorizontalSync() {
        // Cần lấy lại các phần tử DOM ngay trong hàm này nếu chúng bị lỗi khởi tạo
        ...
        fakeWrapper.addEventListener('scroll', () => {
            this.cardsContainer.scrollLeft = fakeWrapper.scrollLeft;
        });
        ...
        fakeWrapper.style.display = this.isMobileView ? 'none' : 'block';
    }
