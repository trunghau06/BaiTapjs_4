class ResponsiveVirtualView {
    constructor() {
        ...
        this.fakeWrapper = document.querySelector('.fake-scroll-wrapper'); // wrapper scroll giả
        this.fakeScroll = document.getElementById('fakeScroll');           // thanh scroll giả
    ...
    setupHorizontalSync() {
    // Đặt minWidth cho fake scroll dựa vào table
    ...
    // Khi cuộn cards container, cập nhật thanh giả (nếu không phải mobile)
    ...
    // Khi window resize, cập nhật lại minWidth fake scroll
