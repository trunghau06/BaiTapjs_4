class VirtualCards {
    ...
    // Tao card mau tam thoi de do dac kich thuoc chinh xac
    createTemporaryCard() {
    ...
    calculateLayout() {
        ...
        if (this.cardHeight > 0) {
            ...
            this.visibleRows = Math.ceil(containerHeight / this.cardHeight) + 1; // So hang nhin thay + 1 hang du phong
        } else {
             this.visibleRows = 5; // Gia tri mac dinh cho so hang
             this.cardHeight = 450; // Gia tri mac dinh cho chieu cao
        }
    }
    ...
    render() {
        ...
        const adjustedStartRow = Math.max(0, startRow - this.bufferRows); // Hang bat dau co tru buffer
