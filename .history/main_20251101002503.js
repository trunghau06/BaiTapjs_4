class ResponsiveVirtualView {
    constructor() {
        ...
        // Scroll ngang giả
        this.table = this.tableView.querySelector('.data-table');
    ...
    async init() {
        ...
        window.requestAnimationFrame(() => { 
            ...
            this.setupHorizontalSync(); // <--- thêm scroll ngang giả
            this.render(); 
    ...
    // --- SCROLL NGANG GIẢ ---
    setupHorizontalSync() {
        if (!this.fakeScroll || !this.fakeWrapper) return;
    ...
    createCardElement(item) {
        ...
        if (!tempDiv.firstChild) return document.createElement('div'); 
        ...
        return `
            <div class="card" data-id="${item.id}">
                ...
                <div class="card-body">
                    ...
                    <div class="card-item"><i class="fa-solid fa-music card-icon"></i> <strong>Music:</strong> ${item.music ||
