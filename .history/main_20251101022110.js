class ResponsiveVirtualView {
    ...
    setupHorizontalSync() {
        // 💥 ĐIỀU KIỆN TIÊN QUYẾT: Đảm bảo các thẻ tồn tại trong DOM
        if (!this.fakeScroll || !this.fakeWrapper || !this.table) {
            console.warn("Fake scroll elements not found. Horizontal sync disabled.");
            return;
        }
