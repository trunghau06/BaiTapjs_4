...
// ---------- Virtual Pagination Variables ----------
const rowHeight = 50; // px, chiều cao ước lượng mỗi row
let visibleRows = 0;

// Tính số row hiển thị dựa trên viewport
function calculateVisibleRows() {
    const containerHeight = scrollContainer.clientHeight; // ví dụ 68vh
    visibleRows = Math.ceil(containerHeight / rowHeight) + 1; // +1 tránh tràn scroll
}

// Render những row đang hiển thị
function renderVisibleTableRows() {
    ...
    tableBodyElement.innerHTML = ""; // xóa cũ
...
scrollContainer.addEventListener("scroll", renderVisibleTableRows);
