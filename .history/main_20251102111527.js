...
let currentPage = 1;
const itemsPerPage = 9; // render 10 items mỗi lần
...
async function loadMoreData() {
    ...
    // Hiển thị loader
    if (currentPage === 1) {
        loaderElement.style.display = "block"; // loader đầu
    } else {
        loadMoreElement.style.display = "block"; // loader cuối danh sách
    }
