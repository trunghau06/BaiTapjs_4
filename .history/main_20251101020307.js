class ResponsiveVirtualView {
    ...
    async init() {
        ...
        window.requestAnimationFrame(() => { 
            ...
            this.setupHorizontalSync(); // 💥 GỌI HÀM ĐỒNG BỘ CUỘN NGANG GIẢ
            this.render(); 
