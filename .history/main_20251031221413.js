...
fakeScroll.parentElement.addEventListener('scroll', (e) => {
  cardsContainer.scrollLeft = e.target.scrollLeft;
});

// Khi scroll nội dung thật, đồng bộ thanh giả
cardsContainer.addEventListener('scroll', (e) => {
  fakeScroll.parentElement.scrollLeft = e.target.scrollLeft;
});
