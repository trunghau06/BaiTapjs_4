...
function appendNewItems(dataList) 
{
    dataList.forEach(user => {
        ...
        tableRow.innerHTML = `
            <td>${user.id               || 'N/A'}</td>
            <td><img src="${user.avatar || 'images/default-avatar.png'}" alt="${user.name}" class="avatar-small" loading="lazy"></td>
            <td>${user.name             || 'N/A'}</td>
        ...
        cardElement.innerHTML = `
            <div class="card-header">
               <img src="${user.avatar                       || 'images/default-avatar.png'}" alt="${user.name}" class="avatar" loading="lazy">
                <div class="card-info">
