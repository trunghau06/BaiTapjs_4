class VirtualCards {
    ...
    initialRender() {
        ...
        initialCards.forEach(item => this.renderedCardIds.add(Number(item.id)));
    }
        ...
        return `
            <div class="card" data-id="${item.id}">
                ...
                <div class="card-body">
                    ...
                    <div class="card-item"><i class="fa-solid fa-music card-icon"></i> <strong>Music:</strong> ${item.music || 'N
