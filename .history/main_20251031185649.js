class VirtualCards {
    ...
    async loadInitialData() {
        ...
        try {
            ...
            // Đảm bảo data luôn được sắp xếp theo ID
    ...
    // Tạo card mẫu tạm thời để đo đạc kích thước chính xác
    createTemporaryCard() {
    ...
    calculateLayout() {
        ...
        // Tính cardsPerRow dựa trên Responsive Grid CSS
    ...
    // ✅ SỬA ĐỔI: Đã xóa hoàn toàn thẻ span.card-id
    createCardHTML(item) {
