...
// Thêm hàm này vào đâu đó trong file JS
...
// Thay thế hàm loadMoreData hiện tại
async function loadMoreData() {
    ...
    try {
        // 🎯 THÊM SẮP XẾP API và LIMIT ĐỘNG
        ...
        if (dataList.length === 0 || allLoadedData.length >= MAX_ITEMS_TOTAL) {
            ...
            // 🎯 SẮP XẾP LẠI TRÊN CLIENT: Để đảm bảo item mới được chèn xen kẽ đúng vị trí
