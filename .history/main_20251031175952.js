class VirtualCards {
    ...
    render() 
    {
        ...
        // Update chiều cao card thực tế nếu chưa xác định
        const firstCard = this.cardsGrid.querySelector('.card');
        if (firstCard) {
        ...
        // ✅ Không trừ buffer khi tính startIndex
        this.startIndex = startRow * this.cardsPerRow;

        // endRow = startRow + visibleRows + bufferRows
    ...
    renderVisibleCards() {
        ...
        console.log(`🎨 Rendered ${visibleData.length} cards (index ${this.startIndex}-${this.endIndex})`);
    }
