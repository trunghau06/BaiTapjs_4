class VirtualCards {
    constructor() {
        ...
        this.cardsPerRow = 0;
        this.visibleRows = 0;
        this.bufferRows = 2; // Tăng bufferRows lên 2 để có đệm tốt hơn
        this.startIndex = 0;
        this.endIndex = 0;
        ...
        // SỬA: Thêm Set để quản lý ID của các card đang được render trong DOM
    ...
    async init() {
        ...
        // SỬA: Render ban đầu để có card trong DOM trước khi tính layout
        this.initialRender(); 
        this.calculateLayout();
        this.setupScrollListener();
        this.setupResizeListener();
        this.render(); // Render lại với layout đã tính toán chính xác
    ...
    render() 
    {
        ...
        // SỬA: Áp dụng bufferRows vào startIndex (trừ) để tạo đệm phía trên
        const adjustedStartRow = Math.max(0, startRow - this.bufferRows); 
        this.startIndex = adjustedStartRow * this.cardsPerRow;
        
        // SỬA: Áp dụng bufferRows vào endRow (cộng) để tạo đệm phía dưới
        ...
        // SỬA: Dùng adjustedStartRow để tính offset chính xác
