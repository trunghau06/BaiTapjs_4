...
function appendNewItems(dataList) {
    dataList.forEach(user => {
        ...
        if (!cardViewElement.querySelector(`.card[data-id='${user.id}']`)) {
            ...
            <button class="btn-card-action edit-icon" title="Chỉnh sửa"><i class="fa-solid fa-pen"></i></button>
            <button class="btn-card-action delete-icon" title="Xóa"><i class="fa-solid fa-trash"></i></button>
        </div>
