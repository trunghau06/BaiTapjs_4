        ...
        return `
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-item"><i class="fa-solid fa-palette card-icon"></i> <strong>Color:</strong> <span style="color:${item.color || '#000'};font-weight:bold;">${item.color || 'N/A'}</span></div>
