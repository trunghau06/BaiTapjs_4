class ResponsiveVirtualView {
    ...
    async init() {
        ...
        window.requestAnimationFrame(() => { 
            ...
            this.setupHorizontalSync(); // 💥 KÍCH HOẠT ĐỒNG BỘ CUỘN NGANG GIẢ
            this.render(); 
    ...
    async loadData() {
        ...
        try {
            const response = await fetch(
                `https://671891917fc4c5ff8f49fcac.mockapi.io/v2?page=${this.currentPage}&limit=20`
            );
