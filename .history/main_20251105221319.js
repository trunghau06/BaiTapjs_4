...
// Tải toàn bộ dữ liệu trước khi thao tác thêm/xóa
(async () => {
    await loadMoreData();
    while (moreDataAvailable && allLoadedData.length < 100) {
        await loadMoreData();
    }

    // Sau khi đã có đủ 100 record, tiến hành xóa cuối và thêm mới
