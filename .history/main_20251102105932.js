...
let currentPage = 1;
const itemsPerPage = 15; // 🎯 Chỉ tải 15 item mỗi lần
const maxVisibleItems = 15; // 🎯 Chỉ giữ tối đa 15 item trong DOM
let loading = false;
...
function displayNewItems(userList) {
    ...
    // Điều này tạo ra Simple Infinite Scroll/Trimming (khác với Virtual Scroll)
